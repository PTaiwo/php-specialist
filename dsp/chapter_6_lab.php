...
<html>
    ...
    <body>
        ...
        <form action="createChessBoard.php" method="post">
            <label for="row">Number of Rows:</label>
            <input type="number" name="row" id="row" min="1" max="8" value="8">
            <label for="col">Number of Columns:</label>
            <input type="number" name="col" id="col" min="1" max="8" value="8">
